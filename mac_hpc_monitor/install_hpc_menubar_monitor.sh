...
RUNNER="$RUNTIME_DIR/run_hpc_menubar_monitor.sh"

mkdir -p "$HOME/Library/LaunchAgents"
mkdir -p "$RUNTIME_DIR"
cp "$SOURCE_DIR/hpc_menubar_monitor.py" "$RUNTIME_DIR/hpc_menubar_monitor.py"
cp "$SOURCE_DIR/run_hpc_menubar_monitor.sh" "$RUNTIME_DIR/run_hpc_menubar_monitor.sh"
chmod +x "$RUNTIME_DIR/hpc_menubar_monitor.py" "$RUNTIME_DIR/run_hpc_menubar_monitor.sh"
...
<dict>
  ...
  <string>/tmp/bjtu_hpc_menubar_monitor.out.log</string>
  <key>StandardErrorPath</key>
  <string>/tmp/bjtu_hpc_menubar_monitor.err.log</string>
...
echo "runner: $RUNNER"
pgrep -afil "hpc_menubar_monitor.py" || true
