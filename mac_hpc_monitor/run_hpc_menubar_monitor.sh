...
export HPC_MONITOR_ACCOUNT_CAP="${HPC_MONITOR_ACCOUNT_CAP:-4}"
export HPC_MONITOR_DASHBOARD_URL="${HPC_MONITOR_DASHBOARD_URL:-http://127.0.0.1:8765/}"

# The monitor reads saved BJTU account files through helper scripts. It should
...
exec "$HPC_MONITOR_PYTHON" "$MONITOR_DIR/hpc_menubar_monitor.py"
